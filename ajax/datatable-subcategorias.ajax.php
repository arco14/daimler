...
//ACCIONES
$botones=  "<div class='img-thumbnail'><button type='button' class='btn btn-info btn-circle waves-effect waves-circle waves-float' id='datosSubcategoria' idSubcategoria='".$subcategorias[$i]["id"]."' data-toggle='modal' data-target='#modalAgregarSubcategoria'><i class='material-icons'>create</i></button></div>";
//ESTATUS
