            ...
            <div class="block-header">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number " data-from="0"  data-speed="1000" data-fresh-interval="20" id='tituloHC'>5,112</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number " data-from="0"  data-speed="1000" data-fresh-interval="20" id='tituloPorcentaje'></div>
                        </div>
                    </div>
                </div>
                </div>
                ...
                <!-- Nav tabs -->
                                    <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                        ...
                                        <li role="presentation" id="tabInventarios"><a href="#tab_4" data-toggle="tab">INVENTARIOS</a></li>
                                    ...
                                    <tfoot>
                                        ...
                                        <table class="table table-bordered text-center" id="tablaResumenFactura" width="100%">
                                    <thead>
                                        <tr>
                                            <th>Entrega</th>
                                            <th>Prenda</th>
