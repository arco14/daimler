$(document).ready(function () {
    ...
    $(document).on("click", "#tabResumenFactura", function () {
        ...
        $('#tablaResumenFactura').DataTable({
            ...
            processing: true,
            columnDefs: [{
                targets: [3, 4], // Índices de las columnas a ocultar
                visible: false,
                searchable: false
            }],
            language: {
    ...
    $(document).on("click", "#tabRegistrados", function () {
        ...
        $('#tablaRegistrados').DataTable({
            ...
            ajax: {
                ...
                type: "POST",
                data: {
                    "action": "consultaRegistradosEntrega"
                }
            },
            order: [
                [2, 'asc']
    ...
    $(document).on("click", "#tabRegistradosEstatus", function () {
        consultarInformacion();
        $('#tablaRegEstatus').DataTable({
            responsive: true,
            destroy: true,
            dom: 'Bfrtip',
            buttons: [{
            ...
            ajax: {
                ...
                type: "POST",
                data: {
                    "action": "consultaRegistradosEstatus"
                }
            },
            order: [
                [2, 'asc']
    ...
    $(document).on("click", "#tabFaltantes", function () {
        ...
        $('#tablaFaltantes').DataTable({
            ...
            ajax: {
                ...
                type: "POST",
                data: {
                    "action": "consultaFaltantesEntrega"
                }
            },
            order: [
                [2, 'asc']
    ...
    $(document).on("click", "#tabResumenEspecialidades", function () {
        ...
        $('#tablaResumenEspecialidades').DataTable({
            ...
            ajax: {
                ...
                type: "POST",
                data: {
                    "action": "consultaResumenEntregaEspecialidades"
                }
            },
            deferRender: true,
            retrive: true,
