...
$(function () {
   // $('.colorpicker').colorpicker();
    ...
    //Mobile Phone Number
    $demoMaskedInput.find('.mobile-phone-number').inputmask('(999) 999-99-99', { placeholder: '(999) 999-99-99' });
    //Phone Number
    ...
    //Peso Money
    $demoMaskedInput.find('.money-peso').inputmask('999.99', { placeholder: '___.__' });
